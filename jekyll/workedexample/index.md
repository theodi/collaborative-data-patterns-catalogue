...
The project has **[Clear Licensing](/patterns/project-governance/clear-licensing)** of its data. To support that it asks for users to agree to **[Contributor Licence](/patterns/project-governance/contributor-licence)** so that rights for reuse of the data in the directory are clear to everyone.
